...
import 'package:oauth2_client/access_token_request.dart' as _i10;
...
import 'package:oauth2_client/src/token_storage.dart' as _i13;
...
class MockOAuth2Client extends _i1.Mock implements _i8.OAuth2Client {
  ...
  @override
  _i9.Future<_i10.AccessTokenRequest?> getTokenRequestWithAuthCodeFlow({
    required String? clientId,
    List<String>? scopes,
    String? clientSecret,
    ...
    Map<String, dynamic>? webAuthOpts,
      ...
      (super.noSuchMethod(
        Invocation.method(
          #getTokenRequestWithAuthCodeFlow,
          [],
          {
            #clientId: clientId,
            #scopes: scopes,
        ...
        returnValue: _i9.Future<_i10.AccessTokenRequest?>.value(),
      ) as _i9.Future<_i10.AccessTokenRequest?>);
  @override
